...
export interface ApiConsultationConsultation
  ...
  attributes: {
    consultationNumber: Schema.Attribute.BigInteger;
    ...
    consultationType: Schema.Attribute.Enumeration<
      ['virtual-call', 'chat', 'email', 'in-person']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiExpertExpert extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    consultationAvailable: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
    ...
    profileBanner: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    publishedAt: Schema.Attribute.DateTime;
    review_and_ratings: Schema.Attribute.Relation<
      'oneToMany',
      'api::review-and-rating.review-and-rating'
    >;
    ...
    user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    verificationDocument: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
...
export interface ApiForumForum extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['Herb Discussion', 'Recipes', 'Products', 'General']
    >;
    content: Schema.Attribute.Blocks;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    forumreplies: Schema.Attribute.Relation<
      'oneToMany',
      'api::forumreply.forumreply'
    >;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::forum.forum'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    related_herb: Schema.Attribute.Relation<'manyToOne', 'api::herb.herb'>;
...
export interface ApiForumreplyForumreply extends Struct.CollectionTypeSchema {
  collectionName: 'forumreplies';
  info: {
    displayName: 'Forumreply';
    pluralName: 'forumreplies';
    singularName: 'forumreply';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiHerbHerb extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    flavor: Schema.Attribute.Text & Schema.Attribute.Required;
    forums: Schema.Attribute.Relation<'oneToMany', 'api::forum.forum'>;
    herbId: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    herbs: Schema.Attribute.Relation<'manyToMany', 'api::herb.herb'>;
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    origin: Schema.Attribute.Text & Schema.Attribute.Required;
    precautions: Schema.Attribute.Text & Schema.Attribute.Required;
    preparation: Schema.Attribute.Text & Schema.Attribute.Required;
    products: Schema.Attribute.Relation<'manyToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    relatedHerbs: Schema.Attribute.Relation<'manyToMany', 'api::herb.herb'>;
    relatedRecipes: Schema.Attribute.Relation<
      'manyToMany',
      'api::recipe.recipe'
    >;
    scientificName: Schema.Attribute.String & Schema.Attribute.Required;
    searchKeywords: Schema.Attribute.JSON & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    uses: Schema.Attribute.JSON & Schema.Attribute.Required;
  };
}
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    price: Schema.Attribute.Decimal;
    productImages: Schema.Attribute.Media<'images' | 'files', true>;
    products: Schema.Attribute.Relation<'manyToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiRecipeRecipe extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    allergenWarnings: Schema.Attribute.JSON;
    benefits: Schema.Attribute.JSON & Schema.Attribute.Required;
    category: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    dietaryInfo: Schema.Attribute.JSON;
    difficulty: Schema.Attribute.Enumeration<
      ['Easy', 'Medium', 'Challenging']
    > &
      Schema.Attribute.Required;
    herbsUseds: Schema.Attribute.Relation<'manyToMany', 'api::herb.herb'>;
...
export interface ApiReviewAndRatingReviewAndRating
  extends Struct.CollectionTypeSchema {
  collectionName: 'review_and_ratings';
  info: {
    displayName: 'Review&Rating';
    pluralName: 'review-and-ratings';
    singularName: 'review-and-rating';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    >;
    title: Schema.Attribute.String;
    unhelpful_count: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    expert: Schema.Attribute.Relation<'oneToOne', 'api::expert.expert'>;
    firstName: Schema.Attribute.String;
    forumreplies: Schema.Attribute.Relation<
      'oneToMany',
      'api::forumreply.forumreply'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::forumreply.forumreply': ApiForumreplyForumreply;
      'api::herb.herb': ApiHerbHerb;
      'api::product.product': ApiProductProduct;
      'api::recipe.recipe': ApiRecipeRecipe;
      'api::review-and-rating.review-and-rating': ApiReviewAndRatingReviewAndRating;
